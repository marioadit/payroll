                        ...
                        <div class="modal-body">
                            <form method="POST" action="{{ route('updateAdmin', $admin->id) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="editRole{{ $admin->id }}" name="role" class="form-control" required>
                                        <option value="Super Admin" {{ $admin->role == 'Super Admin' ? 'selected' : '' }}>Super Admin</option>
                                        <option value="Admin Payroll" {{ $admin->role == 'Admin Payroll' ? 'selected' : '' }}>Admin Payroll</option>
                                    </select>
                                </div>
                                ...
                                @else
                                    <div class="form-group">
                                        ...
                                        <select id="editCompany{{ $admin->id }}" name="id_perusahaan" class="form-control" required>
                                            <option value="" selected disabled>Select Company</option>
                                            @foreach ($perusahaan as $company)
                                                <option value="{{ $company->id }}" {{ $admin->id_perusahaan == $company->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    <label for="editPassword{{ $admin->id }}">New Password:</label>
                                    <input type="password" id="editPassword{{ $admin->id }}" name="password" class="form-control"
                                        placeholder="Leave blank if you don't want to change the password">
                                </div>
                                <div class="form-group">
                                    <label for="editPasswordConfirmation{{ $admin->id }}">Confirm New Password:</label>
                                    <input type="password" id="editPasswordConfirmation{{ $admin->id }}" name="password_confirmation"
